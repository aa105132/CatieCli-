    ...
    <div className="min-h-screen flex items-center justify-center p-4 parchment-wash dark:night-wash bg-parchment-200 dark:bg-night-200">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-inkbrown-300 dark:text-sand-400 mt-2">创建你的账号</p>
        </div>

        {/* 注册卡片 - 支持暗色模式 */}
        <div className="card parchment-border dark:bg-night-100 dark:border-night-50">
          <h2 className="text-xl font-semibold mb-6 text-center text-inkbrown-500 dark:text-sand-200">注册新账户</h2>
          ...
          {discordOnly && discordEnabled && (
            <div className="text-center py-6">
              <div className="bg-[#5865F2]/10 border border-[#5865F2]/30 rounded-lg p-6 mb-6">
                ...
                <p className="text-inkbrown-500 dark:text-sand-300 mb-2">本站仅允许通过 Discord 注册</p>
                <p className="text-inkbrown-300 dark:text-sand-400 text-sm">点击下方按钮使用 Discord 账号注册</p>
              </div>
              ...
              <p className="text-center text-inkbrown-300 dark:text-sand-400 mt-6">
                已有账号？{' '}
                <Link to="/login" className="text-cinnabar-500 hover:text-cinnabar-600 dark:text-cinnabar-400 dark:hover:text-cinnabar-300">
                  立即登录
                </Link>
              </p>
            </div>
