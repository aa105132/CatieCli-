    ...
    <div className="min-h-screen">
      ...
      {showGuide && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-night-100 rounded-2xl max-w-md w-full p-6 border border-wisteria-500/50">
      ...
      {showQuiz && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-night-100 rounded-2xl max-w-md w-full p-6 border border-indigo-500/50">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="bg-purple-500/10 border border-purple-500/30 rounded-xl p-4">
          <div className="flex items-start gap-3">
            <TaijiIcon className="w-6 h-6 text-purple-400 flex-shrink-0 mt-0.5" />
            <div>
