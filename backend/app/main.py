...
from app.routers import cursor_proxy
...
app.include_router(antigravity_proxy.router)  # Antigravity API 反代 (OpenAI 格式)
app.include_router(antigravity_anthropic.router)  # Antigravity Anthropic 格式 (/v1/messages)
app.include_router(antigravity_gemini.router)  # Antigravity Gemini 原生格式 (:generateContent)
...
app.include_router(cursor_proxy.router)  # Cursor API 反代
